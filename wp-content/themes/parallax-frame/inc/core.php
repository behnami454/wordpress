...
function parallax_frame_scripts() {
	...
	if ( 'disabled' != $options['featured_slider_option'] || $options['featured_content_slider'] || 'disabled' != $options['logo_slider_option']  ) {
		...
		if ( 'scrollVert' ==  $options['featured_slider_transition_effect'] ){
			wp_enqueue_script( 'jquery-cycle2-scrollVert', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.scrollVert.min.js', array( 'jquery-cycle2' ), PARALLAXFRAME_THEME_VERSION, true );
		}
		...
		elseif ( 'flipHorz' ==  $options['featured_slider_transition_effect'] || 'flipVert' ==  $options['featured_slider_transition_effect'] ){
			wp_enqueue_script( 'jquery-cycle2-flip', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.flip.min.js', array( 'jquery-cycle2' ), PARALLAXFRAME_THEME_VERSION, true );
		}
		...
		elseif ( 'tileSlide' ==  $options['featured_slider_transition_effect'] || 'tileBlind' ==  $options['featured_slider_transition_effect'] ){
			wp_enqueue_script( 'jquery-cycle2-tile', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.tile.min.js', array( 'jquery-cycle2' ), PARALLAXFRAME_THEME_VERSION, true );
		}
		// Shuffle transition plugin addition
		elseif ( 'shuffle' ==  $options['featured_slider_transition_effect'] ){
			wp_enqueue_script( 'jquery-cycle2-shuffle', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.shuffle.min.js', array( 'jquery-cycle2' ), PARALLAXFRAME_THEME_VERSION, true );
		}
		else {
			if ( 'disabled' != $options['logo_slider_option'] ) {
				wp_enqueue_script( 'jquery-cycle2-carousel', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/jquery.cycle/jquery.cycle2.carousel.min.js', array( 'jquery-cycle2' ), PARALLAXFRAME_THEME_VERSION, true );
			}
			else {
...
function parallax_frame_enqueue_metabox_scripts() {
    //Scripts
	wp_enqueue_script( 'parallax-frame-metabox', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'js/metabox.min.js', array( 'jquery' , 'jquery-ui-tabs' ), '2013-10-05' );

	//CSS Styles
	wp_enqueue_style( 'parallax-frame-metabox-tabs', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/metabox-tabs.css' );
}
